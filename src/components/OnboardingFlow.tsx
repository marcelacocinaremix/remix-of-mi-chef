              ...
              >
                ...
                <div className="relative my-4">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-black px-2 text-white/50">{t("onboardingOrWithEmail")}</span>
                  </div>
                </div>
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full py-6 text-lg rounded-xl border-white/20 bg-white/5 hover:bg-white/10 text-white"
                  onClick={async () => {
                    setIsLoading(true);
                ...
                >
                  ...
                  {t("onboardingContinueWithGoogle")}
                </Button>
