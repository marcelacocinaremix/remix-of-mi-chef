      ...
      >
        ...
        >
          ...
          {item.quantity && item.quantity > 1 && (
            <div className="absolute -top-2 right-0 z-20 bg-primary text-primary-foreground text-[9px] font-bold px-1.5 py-0.5 rounded-full shadow-sm animate-[bounce_0.5s_ease-out]">
              x{item.quantity}
            </div>
          )}
