...
export default function Auth() {
  ...
  // Check for password reset token in URL hash (Supabase sends it as hash fragment)
  useEffect(() => {
  ...
  }, [navigate, returnTo, isResetPassword]);
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Tu contraseña fue cambiada exitosamente. Ya podés iniciar sesión.",
      });
  ...
  // Reset password form (when user comes from email link)
  if (isResetPassword) {
    return (
